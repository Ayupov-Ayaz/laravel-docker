@extends('site.layout', ['title' => 'Вакансии', 'title_bg' => 'vacancies.jpg', 'page' => 'vacancies', 'description' => 'Вакансии'])

@section('content')
    <div class="pt_wrapper col-xs-12">

        <h1 class="p_title">Вакансии</h1>
            ...
            <div class="col-xs-12">
                ...
                <div class="header_switch">
                    <div class="wrapper">
                        ...
                        <a href="{{ URL::route('jobs', ['city_id' => $city->id]) }}" @if($city_id == $city->id) class="_active" @endif >{{ $city->name }}</a>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="flex_w _jc_sb">
                    @foreach($jobs as $job)
                        <a href="{{ URL::route('job', ['id' => $job->id]) }}" class="vac_item">
                            <span>
                                <span class="des">
